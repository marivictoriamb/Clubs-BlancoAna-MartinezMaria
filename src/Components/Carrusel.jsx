    ...
    <div className={styles.slider}>
      <div className={styles.slide}>
        ...
        <div className={styles.Img} id={styles.first} ref={firstElementRef}>
          <img alt="carousel" src="../public/1.png" className={styles.img} />
        </div>

        <div className={styles.Img} >
          <img alt="carousel" src="../public/2.png" className={styles.img} />
        </div>

        <div className={styles.Img} >
          <img alt="carousel" src="../public/3.png" className={styles.img} />
        </div>
